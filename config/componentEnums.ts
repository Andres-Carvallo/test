...
export interface ComponentData {
  id: string; // Placeholder - se actualiza después de crear via API
  defaultData: any;
...
// Usar la imagen base64 importada desde utils/imageUtils
...
export const PIXELUP_COMPONENT_DATA: Record<PIXELUPComponents, ComponentData> = {
  ...
  [PIXELUPComponents.SEO_BANNER]: {
    id: '42bc033c-e8aa-4301-8c8a-25f75cc1edbf', // ID real del banner SEO
    type: 'banner',
    jsonStructure: 'seo',
  ...
  [PIXELUPComponents.SEO_BANNER_IMG]: {
    id: 'f0f2aad1-291e-4aab-b3c9-befe227290c6', // ID real de la imagen SEO
    type: 'banner',
    jsonStructure: 'seo',

...
const ProductDetail02: React.FC = () => {
      ...
      <>
        ...
        <div className="">
          <div className="relative max-w-4xl mx-auto overflow-hidden">
            <button
              className="lg:hidden absolute top-1/2 left-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 z-10"
              onClick={() => moveSlide(-1)}
            >
              &#10094;
            </button>
            ...
            <button
              className="lg:hidden absolute top-1/2 right-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 z-10"
              onClick={() => moveSlide(1)}
            >
              &#10095;
            </button>
                  ...
                  {Object.entries(currentAttributes).map(
                    ([attributeName, attributeValues]) => (
                      <div key={attributeName}>
                        <h4 className="text-primary font-semibold">{attributeName}:</h4>
                        <div className="flex">
...
{/*                   <div className="flex flex-col items-center space-y-2">
                  ...
                  <button
                    ...
                    className={`md:max-w-96 w-full h-16 px-6 py-2 text-[0.8rem] md:text-md font-semibold bg-primary text-white hover:bg-secondary hover:text-primary ${
                      hasVariations &&

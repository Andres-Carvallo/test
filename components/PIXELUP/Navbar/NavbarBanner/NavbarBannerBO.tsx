              ...
              <div className="absolute inset-0 bg-gradient-to-r from-black/30 to-black/10">
                <div className="container mx-auto px-6 h-full flex items-center">
                  <div className="max-w-2xl pl-6 xl:pl-0">
                    ...
                    <button className="bg-white text-[#4A6741] px-8 py-3 rounded-full hover:bg-white/90 transition duration-300 shadow-md hover:shadow-lg font-montserrat text-sm tracking-wider uppercase">
                      {/* Evaluación gratuita */}
                      {formData.buttonText}
                    </button>
                  </div>

...
const Categoria05: React.FC<Categoria05Props> = ({ Categoria05Data }) => {
  const { titulo, categoria1, img1, categoria2, img2, categoria3, img3, categoria4, img4 } = Categoria05Data;
  ...
  const getDefaultBanner = (index: number) => {
    return bannerData && bannerData[index] ? bannerData[index] : { mainImage: { url: defaultImage }, title: 'Titulo por defecto' };
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative flex flex-col items-center w-full">
            <Link href="#" target="_blank" rel="noopener noreferrer" className="w-full">
              <div
                className="w-[180px] h-[400px] md:w-[300px] md:h-[500px] lg:w-[400px] lg:h-[500px] bg-cover bg-center mx-auto"
                style={{
                  backgroundImage: `url(${getDefaultBanner(0).mainImage.url})`,
                  borderRadius: 'var(--radius)',
                  backgroundPosition: 'center bottom',
                }}
              >
                <div className="w-full h-full flex items-end justify-start p-4" style={{ borderRadius: 'var(--radius)' }}>
                  <h2 className="text-2xl md:text-4xl font-bold text-white">{getDefaultBanner(0).title}</h2>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="relative flex flex-col items-center w-full">
            <Link href="#" target="_blank" rel="noopener noreferrer" className="w-full">
              <div
                className="w-[180px] h-[280px] md:w-[300px] md:h-[380px] lg:w-[400px] lg:h-[380px] bg-cover bg-center mx-auto"
                style={{
                  backgroundImage: `url(${getDefaultBanner(1).mainImage.url})`,
                  borderRadius: 'var(--radius)',
                }}
              >
                <div className="w-full h-full flex items-end justify-end p-4" style={{ borderRadius: 'var(--radius)' }}>
                  <h2 className="text-2xl md:text-4xl font-bold text-white">{getDefaultBanner(1).title}</h2>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="relative flex flex-col items-center w-full">
            <Link href="#" target="_blank" rel="noopener noreferrer" className="w-full">
              <div
                className="w-[180px] h-[160px] md:w-[300px] md:h-[260px] lg:w-[400px] lg:h-[260px] bg-cover bg-center mx-auto"
                style={{
                  backgroundImage: `url(${getDefaultBanner(2).mainImage.url})`,
                  borderRadius: 'var(--radius)',
                }}
              >
                <div className="w-full h-full flex items-start justify-start p-4" style={{ borderRadius: 'var(--radius)' }}>
                  <h2 className="text-2xl md:text-4xl font-bold text-white">{getDefaultBanner(2).title}</h2>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="relative flex flex-col items-center w-full mt-0 md:mt-[-120px]">
            <Link href="#" target="_blank" rel="noopener noreferrer" className="w-full">
              <div
                className="w-[180px] h-[280px] md:w-[300px] md:h-[380px] lg:w-[400px] lg:h-[380px] bg-cover bg-center mx-auto"
                style={{
                  backgroundImage: `url(${getDefaultBanner(3).mainImage.url})`,
                  borderRadius: 'var(--radius)',
                }}
              >
                <div className="w-full h-full flex items-end justify-end p-4" style={{ borderRadius: 'var(--radius)' }}>
                  <h2 className="text-2xl md:text-4xl font-bold text-white">{getDefaultBanner(3).title}</h2>
                </div>
              </div>
            </Link>
          </div>

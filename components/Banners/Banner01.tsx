...
const Banner01 = () => {
  return (
    <section
      ...
      className="w-full"
    >
      <div className="relative h-[450px] bg-[#ffecec] overflow-hidden px-6 font-[sans-serif]">
        <div className="absolute -top-6 -left-6 w-20 h-20 rounded-full bg-blue-300" />
        <div className="absolute -bottom-6 -left-0 w-24 h-20 rounded-tr-[40px] bg-teal-200" />
        <div className="absolute -top-6 -right-6 w-20 h-20 rounded-full bg-teal-200" />

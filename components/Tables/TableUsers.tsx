          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-dark text-left dark:bg-meta-4 hidden">
                ...
                <th className="min-w-[220px] py-4 px-4 font-medium text-primary dark:text-white xl:pl-11">
                  Nombre / Apellido
                </th>
                <th className="min-w-[150px] py-4 px-4 font-medium text-primary dark:text-white">
                  Email
                </th>
                <th className="min-w-[120px] py-4 px-4 font-medium text-primary dark:text-white">
                  ROL
                </th>
              ...
              {Usuarios.map((userDetail, key) => (
                ...
                >
                  ...
                  <td className="border-b border-dark py-5 px-4 dark:border-dark">
                    <p
                      className={`inline-flex rounded-full bg-primary py-1 px-3 text-sm font-medium `}
                    >

            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`text-[14px] group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-normal text-secondary duration-300 ease-in-out hover:bg-black/10 ${
                    pathname.includes("/dashboard/tienda-pixelup") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                  onClick={() => handleLinkClick("/dashboard/tienda-pixelup")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <li>
                <Link
                  ...
                  onClick={() =>
                    handleLinkClick("/dashboard/suscripciones/estado")
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {/* Menu Item Blog */}
              <SidebarLinkGroup
                activeCondition={pathname.includes("/dashboard/blog")}
              >
                {(handleClick, open) => (
                  <React.Fragment>
                    <Link
                      href="#"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-secondary duration-300 ease-in-out hover:bg-black/10 ${
                      ...
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
                          <Link
                            ...
                            onClick={() => handleLinkClick("/dashboard/blog")}
                          >
                            - Posts
                          </Link>
                        </li>
                        <li>
                          <Link
                            ...
                            onClick={() =>
                              handleLinkClick("/dashboard/blog/categories")
                            }
                          >
                            - Categorías
                          </Link>

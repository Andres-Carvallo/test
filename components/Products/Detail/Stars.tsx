                ...
                <div className="box flex flex-col gap-y-4 w-full max-xl:max-w-3xl mx-auto">
                  <div className="flex items-center w-full">
                    ...
                    <p className="h-2 w-full sm:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                      <span className="h-full w-[30%] rounded-[30px] bg-primary flex" />
                    </p>
                    <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                      30
                    </p>
                  ...
                  <div className="flex items-center w-full">
                    ...
                    <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                      <span className="h-full w-[40%] rounded-[30px] bg-primary flex" />
                    </p>
                    <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                      40
                    </p>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                      <span className="h-full w-[20%] rounded-[30px] bg-primary flex" />
                    </p>
                    <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                      20
                    </p>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                      <span className="h-full w-[16%] rounded-[30px] bg-primary flex" />
                    </p>
                    <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                      16
                    </p>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="h-2 w-full xl:min-w-[278px] rounded-[30px] bg-gray-200 ml-5 mr-3">
                      <span className="h-full w-[8%] rounded-[30px] bg-primary flex" />
                    </p>
                    <p className="font-medium text-lg py-[1px] text-black mr-[2px]">
                      8
                    </p>
                ...
                <div className="grid grid-cols-12 h-full px-8 max-lg:py-8 rounded-3xl bg-gray-100 w-full max-xl:max-w-3xl max-xl:mx-auto">
                  ...
                  <div className="col-span-12 md:col-span-4 max-lg:mt-8 md:pl-8">
                    <div className="flex items-center flex-col justify-center w-full h-full ">
                      <button className="rounded-full px-6 py-4 bg-dark font-semibold text-lg text-white whitespace-nowrap mb-6 w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-primary hover:shadow-primary/50 hover:text-dark">
                        Write A Review
                      </button>
                      <button className="rounded-full px-6 py-4 bg-white font-semibold text-lg text-dark whitespace-nowrap w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-dark/10 hover:shadow-dark">
                        See All Reviews
                      </button>
                    </div>
                  </div>

...
function ProductoSimple() {
  ...
  return (
    <div className="py-10 lg:pb-24 relative ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-16">
          <div className="pro-detail max-lg:max-w-[608px] max-lg:mx-auto lg:w-1/2 flex flex-col justify-center">
            {products &&
              products.productTypes.map((productType: any, index: any) => (
                <p
                  key={index}
                  className="font-medium text-md text-primary mb-4 bg-dark w-fit p-1 px-2 rounded-xl"
                >
                  {productType.name}
                </p>
              ))}
          ...
          <div className="slider-box lg:w-1/2 max-lg:max-w-[680px] max-lg:mx-auto">
            <div className="col-span-4">
              <img
                ...
                className="w-full h-auto xl:min-w-[608px] aspect-square rounded-xl"
              />
            </div>
            <div className="grid grid-cols-4 gap-4 lg:gap-6 mt-4 lg:mt-6">
              <img
                ...
                className="w-full h-auto cursor-pointer border-2 border-gray-50 transition-all duration-500 hover:border-indigo-600"
              />
              <img
                src="https://pagedone.io/asset/uploads/1700471890.png"
                alt="Travel Bag image"
                className="w-full aspect-square cursor-pointer border-2 border-gray-50 transition-all duration-500 hover:border-indigo-600"
              />
              <img

...
const ExchangesGrid = () => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedCategories, searchQuery, pageNumber, pageSize, exchanges, selectedCompany]);
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 text-white py-8"> {/* Reducido de py-16 a py-8 */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {isLoading ? (
            ...
            Array(pageSize).fill(0).map((_, index) => (
              <div key={`skeleton-${index}`} className="bg-white rounded-2xl shadow-md overflow-hidden animate-pulse">
                <div className="relative">
                  <div className="w-full h-56 bg-gray-200"></div>
                  <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 
                    w-36 h-36 rounded-xl border-4 border-white bg-gray-200"></div>
                </div>
                ...
                <div className="relative">
                  ...
                  <img
                    ...
                    className="absolute -bottom-8 left-1/2 transform -translate-x-1/2
                      w-36 h-36 rounded-xl border-4 border-white shadow-lg bg-white 
                      object-contain p-1 z-20"
                  />
                </div>

                <div className="p-6 pt-12">
                  <h3 className="text-xl font-bold text-center text-gray-800 mb-2 group-hover:text-rosa transition-colors">
                    {exchange.name}
                  </h3>
                  ...
                  <div className="prose prose-sm max-w-none">
                    <ReactQuill
                      ...
                      readOnly={true}
                      theme="bubble"
                      className="text-gray-600 min-h-[100px] max-h-[100px] overflow-hidden"
                    />
                  </div>

                  <Link href={`/dashboard/tienda-pixelup/${exchange.id}`}>
                    <button
                      className="w-full mt-6 bg-gradient-to-r from-gray-800 to-gray-600

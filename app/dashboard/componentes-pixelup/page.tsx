    ...
    components: [
      {
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/4ade80/ffffff?text=Banner+01",
      },
      {
        id: "banner-02",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/22d3ee/ffffff?text=Banner+02",
      },
      {
        id: "parallax-01",
        name: "Parallax 01",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/06b6d4/ffffff?text=Parallax+01",
      },
      {
        id: "parallax-02",
        name: "Parallax 02",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/0891b2/ffffff?text=Parallax+02",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/a855f7/ffffff?text=Hero+01",
      },
      {
        id: "hero-02",
        name: "Hero 02",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/9333ea/ffffff?text=Hero+02",
      },
      {
        id: "hero-03",
        name: "Hero 03",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/7c3aed/ffffff?text=Hero+03",
      },
      {
        id: "hero-04",
        name: "Hero 04",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/6d28d9/ffffff?text=Hero+04",
      },
      {
        id: "hero-05",
        name: "Hero 05",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/5b21b6/ffffff?text=Hero+05",
      },
      {
        id: "hero-06",
        name: "Hero 06",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/4c1d95/ffffff?text=Hero+06",
      },
      {
        id: "hero-07",
        name: "Hero 07",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/581c87/ffffff?text=Hero+07",
      },
      {
        id: "hero-08",
        name: "Hero 08",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/701a75/ffffff?text=Hero+08",
      },
      {
        id: "hero-09",
        name: "Hero 09",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/86198f/ffffff?text=Hero+09",
      },
      {
        id: "galeria-01",
        name: "Galería 01",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/be185d/ffffff?text=Galeria+01",
      },
      {
        id: "galeria-02",
        name: "Galería 02",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/e11d48/ffffff?text=Galeria+02",
      },
      {
        id: "servicios-01",
        name: "Servicios 01",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/f43f5e/ffffff?text=Servicios+01",
      },
      {
        id: "servicios-02",
        name: "Servicios 02",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/ec4899/ffffff?text=Servicios+02",
      },
      {
        id: "servicios-03",
        name: "Servicios 03",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/db2777/ffffff?text=Servicios+03",
      },
      {
        id: "servicios-04",
        name: "Servicios 04",
        ...
        usePreview: true,
        thumbnail:
          "https://via.placeholder.com/300x200/be185d/ffffff?text=Servicios+04",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        component: () => (
          <ProductCardWrapper
            ...
            text="Productos Destacados - Card 01"
          />
        ),
        usePreview: true,
      },
      {
        ...
        component: () => (
          <ProductCardWrapper
            ...
            text="Productos Destacados - Card 02"
          />
        ),
        usePreview: true,
      },
      {
        ...
        component: () => (
          <ProductCardWrapper
            ...
            text="Productos Destacados - Card 03"
          />
        ),
        usePreview: true,
      },
      {
        ...
        component: () => (
          <ProductCardWrapper
            ...
            text="Productos Destacados - Card 04"
          />
        ),
        usePreview: true,
      },
      {
        ...
        component: () => (
          <ProductCardWrapper
            ...
            text="Productos Destacados - Card 05"
          />
        ),
        usePreview: true,
      },
...
export default function Componentes() {
  ...
  const handlePreviewClick = (component: any) => {
    ...
    if (currentCategory) {
      const index = currentCategory.components.findIndex(
    ...
    if (direction === "prev") {
      newIndex =
        currentComponentIndex > 0
          ...
          : currentCategory.components.length - 1;
    } else {
      newIndex =
        currentComponentIndex < currentCategory.components.length - 1
          ? currentComponentIndex + 1
          : 0;
    }
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100">
              <div className="flex items-center justify-center space-x-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  ¿Necesitas un componente personalizado?
                </h3>
              </div>
              <p className="text-gray-600 mb-4">
                Si no encuentras el componente que necesitas en nuestro
                catálogo, podemos crear uno específico para ti.
              </p>
              <a
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <div className="flex items-center space-x-3">
                <div className="text-sm text-gray-500 font-medium">
                  {currentComponentIndex + 1} de{" "}
                  {currentCategory?.components.length}
                </div>
                <button
                  onClick={closeModal}

...
import BannerAboutBO from "@/components/PIXELUP/BannerAbout/BannerAbout/BannerAboutBO";
...
export default function BannerHome() {
  ...
  return (
    <section className="gap-4 flex flex-col py-10 mx-4">
      ...
      {[
        { id: "bannerAbout", title: "Banner About", component: <BannerAboutBO /> },
        { id: "aboutUs", title: "About Us Texto", component: <About01BO /> },
      ].map((section) => (
        <div
          key={section.id}

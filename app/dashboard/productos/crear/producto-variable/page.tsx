...
const CrearProductoVariable: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        setMeasures({
          length: productData.measures.length || null,
          width: productData.measures.width || null,
          height: productData.measures.height || null,
          weight: productData.measures.weight || null,
        });
  ...
  const handleClearImage = (
    ...
    setIsUploaded(false); // Indicar que la imagen no ha sido cargada
  };
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (isEditMode) {
          const productId: string = "none";
          console.log(`El ID del producto es: ${productId}`);
          console.log(`El ID del SKU es: ${responseData.skuId}`);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        <div>
          ...
          {previewImage ? (
            ...
            <div className="mt-2">
              <h1>Foto de Previsualización</h1>
              <label

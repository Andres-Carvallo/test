...
const CrearProductoSimple: React.FC = ({}) => {
  ...
  const handleMeasureChange = (e: any, measure: any) => {
    const value = parseFloat(e.target.value); // Asegúrate de que el valor sea un número decimal
    setFormData((prevFormData: any) => ({
      ...prevFormData,
      measures: {
        ...prevFormData.measures,
        [measure]: value > 0 ? value : 0, // Permite valores decimales mayores que 0, y coloca 0 si es negativo
      },
    }));
  };
